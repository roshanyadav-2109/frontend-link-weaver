...
const testimonials = [
  {
    author: {
      name: "Sarah Johnson",
      handle: "Procurement Director, Global Retail Inc.",
  ...
  },
  {
    author: {
      name: "Rajesh Mehta",
      handle: "CEO, Premium Textiles Ltd.",
  ...
  },
  {
    author: {
      ...
      handle: "Supply Chain Manager, European Markets Group",
  ...
  },
  {
    author: {
      name: "Maria Chen",
      handle: "Operations Director, Asian Trade Solutions",
  ...
  },
  {
    author: {
      name: "Ahmed Hassan",
      handle: "Import Manager, Middle East Distributors",
