      ...
      <div className="container mx-auto px-4 pt-12 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/auth/manufacturer" className="text-gray-300 hover:text-white">Sign In</Link>
              </li>
              <li>
                <Link to="/auth/manufacturer?register=true" className="text-gray-300 hover:text-white">Register</Link>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Submit Products</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white">Manufacturer Terms</a>
              </li>
            </ul>
          </div>
          <div>
