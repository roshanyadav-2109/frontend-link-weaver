...
import { Mail, Phone, MapPin, Globe, Shield, Users } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-white/10 hover:bg-white/20 text-white h-10 w-10 flex items-center justify-center rounded-full transition-colors shadow-inner">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors hover:underline">Manufacturer Terms</a>
              </li>
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors hover:underline">Export Guidelines</a>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-brand-teal flex-shrink-0" />
                <a href="tel:+919012345678" className="text-gray-300 hover:text-white transition-colors hover:underline">+91 90123 45678</a>
              </li>
              <li className="flex items-center">
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link to="#" className="text-sm text-gray-400 hover:text-white transition-colors">Sitemap</Link>
            </div>
          </div>
        </div>
      </div>
